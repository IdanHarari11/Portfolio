...
import mailTo from "../../../src/assets/AboutMe/mail.png";
        ...
        <div className="back-form">
          ...
          <form>
            <div style={{ textAlign: "center" }}>
              <h4>Click to send me an email !</h4> <br />
              <a
                style={{ cursor: "pointer" }}
                href="mailto:idanharari112@gmail.com"
              >
                <img src={mailTo} style={{ width: "9rem", height: "9rem" }} />
              </a>
            </div>
          </form>
        </div>
